...
all: 
	...
	aflex_ayacc/ayacc/ayacc parser.y extension "=>" .ada
...
clean:
	rm -f *.ada lexer_io.ad[sb] lexer_dfa.ad[sb] lexer.ad[sb]
	rm -f parser.adb parser.ads parser_goto.ads parser_shift_reduce.ads parser_tokens.ads
